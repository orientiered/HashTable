...
4. [Анализ хеш-функций](#хеш-функции)
5. [Методика тестирования](#методика-тестирования)
...
6. [Ход работы](#ход-работы-оптимизации)
...
2. **Открытая адресация**
    ...
    На рисунке показано, как мог выглядеть массив и поиск слова "Hello" в нём. Если у разных ключей совпал индекс в массиве, то они будут лежать на одном пути пробирования. При этом эти цепочки пробирования также могут пересекаться.
...
Время работы уменьшилось, но прирост не очень большой.
